<template>
  <div v-if="chatChatstore.chatSelector == 1" class="pl-5 w-full lg:hidden">
    <p
    ...
    <div class="w-full" v-for="item in chats" :key="item.chat_id">
      <div class="">
        <div
          ...
          v-if="
            item.send_email == chatChatstore.chatEmail && item.receive_email == send_email
          "
        >
          <div>
            <p
        ...
        <div
          ...
          v-if="
            item.send_email == send_email && item.receive_email == chatChatstore.chatEmail
          "
        >
          <div>
    ...
    <div v-if="countMessage == 0"><p>NO MESSAGES</p></div>
    <form action="" class="flex items-center justify-center pr-3">
      <input
    ...
    <div>
      <p class="text-center text-lg font-mono font-bold text-gray-700 dark:text-white">
        ሌሎች አማራጮች
      </p>
      <div

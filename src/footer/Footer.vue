...
<div>
    ...
    <footer class="text-center lg:text-left bg-green-500 text-black inset-x-0 bottom-0">
        <div class="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
            ...
            <div class="flex justify-center">
                ...
                <a href="#!" class="mr-6">
                    <svg class="w-6 h-6 text-white fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
            ...
            <div class="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              ">
                ...
                <div class="">
                    ...
                    <p class="mb-4">
                        <a href="#!" class="">Animals</a>
                    </p>
                    <p class="mb-4">
                        <a href="#!" class="">Vegetables</a>
                    </p>
                    <p class="mb-4">
                        <a href="#!" class="">Seeds</a>
                    </p>
                    <p>
                        <a href="#!" class="">Farming Pages</a>
                    </p>
                </div>
                <div class="">
                    <h6 class="uppercase font-semibold mb-4 flex justify-center md:justify-start">
                    ...
                    <p class="mb-4">
                        <a href="#!" class="">Ethiopian Agricultural service</a>
                    </p>
                    <p class="mb-4">
                        <a href="#!" class="">Amhara Agricultural service</a>
                    </p>
                    <p class="mb-4">
                        <a href="#!" class="">East Gojjam Agricultural service</a>
                    </p>
                    <p>
                        <a href="#!" class="">Help</a>
                    </p>
        ...
        <div class="text-center p-6">
            ...
            <a class="font-semibold" href="https://tailwind-elements.com/">Agricultural Products</a>
        </div>
    </footer>
</div>
</template>
